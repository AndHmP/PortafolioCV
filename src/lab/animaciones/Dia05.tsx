                    ...
                    <div className="grafico w-full flex flex-column relative">
                        ...
                        <div className="red w-full h-full absolute">
                            <div className="absolute point"
                                ...
                                <div className="absolute hoverPoint" data-valuehover='458'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(36px - 2px)', top: 'calc(9px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='812'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(69px - 2px)', top: 'calc(16px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='746'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(102px - 2px)', top: 'calc(10px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='877'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(135px - 2px)', top: 'calc(30px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='517'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(168px - 2px)', top: 'calc(36px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='434'>
                                </div>
                            </div>
                            <div className="absolute point"
                        ...
                        <div className="blue w-full h-full absolute">
                            <div className="absolute point"
                                ...
                                <div className="absolute hoverPoint" data-valuehover='26'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(36px - 2px)', top: 'calc(38px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='41'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(69px - 2px)', top: 'calc(50px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='22'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(102px - 2px)', top: 'calc(40px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='36'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(135px - 2px)', top: 'calc(45px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='25'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(168px - 2px)', top: 'calc(56px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='13'>
                                </div>
                            </div>
                            <div className="absolute point"
                                style={{ left: 'calc(201px - 2px)', top: 'calc(50px - 2px)' }}>
                                <div className="absolute hoverPoint" data-valuehover='20'>
                                </div>
                            </div>
                        </div>
                    </div>
